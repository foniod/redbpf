...
pub const bpf_attach_type___MAX_BPF_ATTACH_TYPE: bpf_attach_type = 14;
...
pub const bpf_func_id___BPF_FUNC_MAX_ID: bpf_func_id = 65;
...
extern "C" {
    pub fn bcc_create_map_xattr(attr: *mut bpf_create_map_attr) -> ::std::os::raw::c_int;
}
extern "C" {
